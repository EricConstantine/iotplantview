                ...
                <Card>
                    ...
                    <Row>
	                    <i-col span="12">
					        ...
					        <Upload action="/api/product/impexcel" :before-upload="handleImpexcelBeforeUpload" :on-success="handleImpexcelSuccess"
...
export default {
    ...
    data () {
     ...
     methods: {
        ...
        handleExpexcel(){
        	...
        	let keywords = this.table.keywords;
        	window.location.href='/api/product/expexcel?sort='+sort+'&size=1000&keywords='+keywords;
        },
    ...
    watch: {
        '$route' (to) {
            ...
            if(to.name=='product-manage' && to.query && to.query.refresh){
